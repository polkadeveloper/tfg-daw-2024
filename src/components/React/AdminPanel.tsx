...
function AdminPanel(props: any) {
  ...
  const [loginAttempts, setLoginAttempts] = useState(props.loginAttempts); // Inicializa loginAttempts con 5 intentos
    ...
    <>
      <article className="relative flex flex-col gap-10 justify-center items-center bg-black/40 border-2 border-white p-20 rounded-lg">
        ...
        <article className="flex justify-center items-center text-black gap-10">
          <button className="bg-green-400 px-2 py-2 rounded-lg">Crear</button>
          <button className="bg-blue-400 px-2 py-2 rounded-lg">
            Actualizar
          </button>
          <button className="bg-red-400 px-2 py-2 rounded-lg">Eliminar</button>
        </article>
